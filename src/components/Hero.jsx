    ...
    <section className=" pb-32 pt-8 relative">
      <div className="flex flex-col justify-center items-center gap-12 lg:gap-8 z-20">
        ...
        <img
          alt="double trouble"
          src="/images/logo.png"
          className="z-20 w-[90vw] lg:w-[50vw]"
        />
      ...
      <img
        ...
        className="w-[30vw] lg:w-[20vw] absolute top-[-3rem] lg:top-[4rem] left-[-2rem] z-50 lg:z-[5] "
      />
      <img
        alt="event images"
        src="images/hero-img2.png"
        className="w-[30vw] lg:w-[20vw] absolute bottom-[1rem] right-[-2rem] lg:bottom-[4rem] lg:right-[3rem] z-[5]"
      />
      {/* cloud images */}
      <img
        alt="cloud"
