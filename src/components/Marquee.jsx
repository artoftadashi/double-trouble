...
const Marquee = () => {
  const content = [
    ...
    { id: 7, image: "/images/heart.svg", text: "•  come with your babe  •" },
    { id: 8, image: "/images/shine.svg", text: "•  come with your bff  •" },
    { id: 9, image: "/images/rainbow.svg", text: "•  come with your bro  •" },
    { id: 10, image: "/images/Music.svg", text: "•  come with your boo  •" },
    {
      id: 11,
      image: "/images/camera.svg",
      text: "• come with your sneaky link •",
